...
let submit = () => {
    form.put('/admin/users/' + props.current_user.id);
};
</script>
...
<template>
    <Head title="Edit User"/>
        <header class="flex justify-between mb-10">
            <h2 class="text-xl md:text-2xl text-slate-700">ویرایش کاربر</h2>
        ...
        <form @submit.prevent="submit" class="flex flex-wrap space-y-4 lg:space-y-2 text-slate-700" autocomplete="off">
            ...
            <div class="pt-6 w-full flex">
                ...
                <Link :href="'/admin/users/' + current_user.id" preserve-scroll method="delete" as="button"
