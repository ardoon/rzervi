...
<template>
    ...
    <div>
        <header>
            <h2 class="text-xl md:text-2xl mb-12 text-slate-700">خدمات</h2>
        </header>

        <Link :href="route('provider.services.create')" class="block mb-3 text-indigo-500 hover:text-indigo-600">
            افزودن خدمت
        </Link>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-xl" :src="'https://i.pravatar.cc/50?u=' + service.id" alt="">
                                        </div>
                                        <div class="mr-4">
                                            <div class="text-sm font-medium text-gray-900">{{ service.name }}</div>
                                            <div class="text-sm text-gray-500">{{ service.pivot.price }} تومان</div>
                                        </div>
                                    </div>
                                </td>
